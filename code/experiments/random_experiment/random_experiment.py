...
def baseline(district, iterations):
    """ create solid solutions given a number of iterations and save solution, histogram and grid of this solution """
    ...
    # plotting_histogram(array_input, x_title, y_title, title)

## koelschema formule
## reheating
## dikkere bins
## battery in aparte plaatjes
